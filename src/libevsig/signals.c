...
SIG_DEFTYPE(SIGNAL_INSUFFICIENT_RESOURCES);
SIG_DEFTYPE(SIGNAL_SOCK_ALREADY_CONNECTED);
SIG_DEFTYPE(SIGNAL_NOT_SOCKET);
SIG_DEFTYPE(SIGNAL_ADDRESS_IN_USE);
SIG_DEFTYPE(SIGNAL_ADDRESS_NOT_AVAILABLE);
SIG_DEFTYPE(SIGNAL_IN_PROGRESS);
SIG_DEFTYPE(SIGNAL_LOOP);
SIG_DEFTYPE(SIGNAL_NAME_TOO_LONG);
SIG_DEFTYPE(SIGNAL_TOO_MANY_LOCKS);
SIG_DEFTYPE(SIGNAL_OVERFLOW);
SIG_DEFTYPE(SIGNAL_NOT_FOUND);
SIG_DEFTYPE(SIGNAL_WOULD_DEADLOCK);
SIG_DEFTYPE(SIGNAL_CONNECTION_REFUSED);
SIG_DEFTYPE(SIGNAL_NETWORK_UNREACHABLE);
SIG_DEFTYPE(SIGNAL_CONNECTION_TIMED_OUT);
SIG_DEFTYPE(SIGNAL_CONNECTION_RESET);
SIG_DEFTYPE(SIGNAL_HOST_UNREACHABLE);
SIG_DEFTYPE(SIGNAL_INTERFACE_DOWN);
